...
class OPiPredictor(nn.Module):
    def __init__(self):
        ...
        self.attn = nn.MultiheadAttention(128, num_heads=4, batch_first=True)  # ✅ fixed
        self.exist_fc = nn.Linear(128, NUM_OPS)  # ✅ fixed
        self.count_fc = nn.Linear(128, NUM_OPS)  # ✅ fixed
...
class LayerDecoder(nn.Module):
    def __init__(self, input_dim, vocab_size):
        ...
        self.norm = nn.LayerNorm(256)  # ✅ FIXED HERE
